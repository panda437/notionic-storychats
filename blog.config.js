const BLOG = {
  title: 'Storychats Blog',
  author: 'Asif Akbar',
  email: 'asif@storychats.com',
  link: 'https://storychats.com',
  newsletter: 'Story Chats',
  description: 'Chat with Characters from books',
  ...
  path: '/blog', // leave this empty unless you want to deploy Notionic in a folder
  ...
  socialLink: {
    twitter: 'https://twitter.com/asifkabeer',
    github: 'https://github.com/panda437',
    telegram: 'https://t.me/asifkabeer'
  },
  seo: {
  ...
  notionDomain: 'asifkabeer.notion.site',
